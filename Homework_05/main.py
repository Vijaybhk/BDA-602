...
def main():
    ...
    df1 = mariadb_df(query=query1)
    df2 = mariadb_df(query=query2)
    df3 = mariadb_df(query=query3)
    ...
    param_grid = {
        'rfc__n_estimators': range(1, 1000, 11),
        'rfc__max_depth': range(1, 100, 6),
    ...
    print(rf_grid_search.best_score_, rf_grid_search.best_estimator_)

    rf_model.set_params(**rf_grid_search.best_params_)
