...
from Homework_04.dataset_loader import TestDatasets
from Homework_04.plotter import combine_html
from utilities import predictor_reports


def main():
    # Name of the data set name to pass in to test datasets, and as "heading of the html"
    data_name = "tips"

    # Getting the dataframe, predictors and response from test datasets
